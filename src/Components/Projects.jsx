...
<div className="flex">
<a href="https://github.com/itsishant/fitmetrix" className="ml-4 flex  font-bold text-lg text-neutral-400 hover:text-neutral-200 mb-1 mt-5">GitHub <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4 ml-1 mt-1.5">
  <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 19.5 15-15m0 0H8.25m11.25 0v11.25"  />
...
<div className="flex">
<a href="https://github.com/itsishant/DevHub" className="ml-4 flex  font-bold text-lg text-neutral-400 hover:text-neutral-200 mb-1 mt-2">GitHub <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4 ml-1 mt-1.5">
  <path strokeLinecap="round" strokeLinejoin="round" d="m4.5 19.5 15-15m0 0H8.25m11.25 0v11.25"  />
  
</svg>

</a>
<a href="https://devhub-ishant.vercel.app/" className="size-6 ml-3 mt-2">
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6" className="hover:text-neutral-200 text-neutral-400" >
  <path stroke-linecap="round" stroke-linejoin="round" d="M13.19 8.688a4.5 4.5 0 0 1 1.242 7.244l-4.5 4.5a4.5 4.5 0 0 1-6.364-6.364l1.757-1.757m13.35-.622 1.757-1.757a4.5 4.5 0 0 0-6.364-6.364l-4.5 4.5a4.5 4.5 0 0 0 1.242 7.244" />
</svg>
