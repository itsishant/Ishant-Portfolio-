...
export const Home = () => (
  <main className="mt-16 md:mt-16 pb-20 flex flex-col">
        ...
        <div className="mt-4 grid grid-cols-1 gap-4 text-sm sm:text-base md:text-xl font-sans text-neutral-900">
          ...
          <div class="flex justify-center items-center md:gap-8 gap-6">
            <motion.div
              ...
              class=" bg-neutral-800/80 h-10 w-32 flex justify-center items-center group relative shadow-[0px_1px_2px_0px_rgba(255,255,255,0.1)inset, 0px-1px_2px_0px_rgba(255,255,255,0.1)_inset] rounded-lg  flex justify-center items-center "
            >
              <motion.button
            ...
            <Link
              ...
              className="text-neutral-400 hover:tracking-tighter tracking-tight text-lg flex justify-center items-center"
            >
    ...
    <About />
    <Contact />
    <div className="w-full text-center border-t border-neutral-700 py-2 mt-10 text-white">
