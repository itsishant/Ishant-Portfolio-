...
export const About = () => {
  ...
  return (
    <div id="aboutMeSection" className="min-h-screen px-4 py-10">
      <h1 className="text-4xl md:text-6xl text-center bg-gradient-to-r from-violet-600 via-fuchsia-500 to-pink-500 bg-clip-text text-transparent  font-bold mb-12 md:mb-24">
        About Me
      </h1>
